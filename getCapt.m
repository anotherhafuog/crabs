...
%hands
captPt11 = [ (0+h)*captSize; 2*captSize; 1]; %left
captPt12 = [ (0+h)*captSize; -2*captSize; 1]; %right
%left spear
captPt13=[ (3+h)*captSize; -2*captSize; 1]; % spear point
captPt14=[ (-1+h)*captSize; -2*captSize; 1]; % spear end
%points unused from here
%right spear
captPt15=[ (3+h)*captSize; 2*captSize; 1]; % spear point
captPt16=[ (-1+h)*captSize; 2*captSize; 1]; % spear end
%elbows
captPt17 = [ 0.5*captSize; 1.5*captSize; 1]; %left
captPt18 = [ 0.5*captSize; -1.5*captSize; 1]; %right
%captain matrix
