...
% This function returns a vector of graphics handles called captainGraphics.
...
capt = T*captRotated;
%defines T as calling getTranslation with xCapt and yCapt
%then multiplies the position of capt by the translation
